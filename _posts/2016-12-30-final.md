...
<img src="{{site.baseurl}}/assets/botones.png" width="100">
FKSDJFKSJDBFKJSBDFKJBS
...
![Variables de ambiente]({{site.baseurl}}/assets/env_var.png=100x)
...
![Parametros]({{site.baseurl}}/assets/param.png=100x)
...
![topicos]({{site.baseurl}}/assets/topics.png=100x)
...
![topic_msg1]({{site.baseurl}}/assets/topicmsg.png=100x)
-> *Topic type presionado* <-

![topic_msg2]({{site.baseurl}}/assets/topicmsg2.png=100x)
